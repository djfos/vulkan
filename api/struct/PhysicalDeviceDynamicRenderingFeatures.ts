...
export class PhysicalDeviceDynamicRenderingFeatures implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceDynamicRenderingFeatures) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceDynamicRenderingFeatures.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
