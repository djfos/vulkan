...
export class BufferDeviceAddressInfo implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitBufferDeviceAddressInfo) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, BufferDeviceAddressInfo.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
