...
export class StdVideoEncodeH265ReferenceInfoFlags implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitStdVideoEncodeH265ReferenceInfoFlags) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, StdVideoEncodeH265ReferenceInfoFlags.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  }
