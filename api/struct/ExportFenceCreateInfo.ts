...
import { ExternalFenceHandleTypeFlags } from "../def.ts";
...
export class ExportFenceCreateInfo implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitExportFenceCreateInfo) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, ExportFenceCreateInfo.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get handleTypes(): ExternalFenceHandleTypeFlags {
