...
export class PhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
