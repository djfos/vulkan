...
export class PhysicalDeviceImageCompressionControlFeaturesEXT implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceImageCompressionControlFeaturesEXT) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceImageCompressionControlFeaturesEXT.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get imageCompressionControl(): Bool32 {
