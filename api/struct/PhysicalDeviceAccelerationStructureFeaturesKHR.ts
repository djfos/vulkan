...
export class PhysicalDeviceAccelerationStructureFeaturesKHR implements BaseStruct {
  ...
  get accelerationStructure(): Bool32 {
  ...
  get accelerationStructureCaptureReplay(): Bool32 {
  ...
  get accelerationStructureIndirectBuild(): Bool32 {
  ...
  get accelerationStructureHostCommands(): Bool32 {
  ...
  get descriptorBindingAccelerationStructureUpdateAfterBind(): Bool32 {
