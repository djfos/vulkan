...
export class PhysicalDeviceCornerSampledImageFeaturesNV implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceCornerSampledImageFeaturesNV) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceCornerSampledImageFeaturesNV.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
