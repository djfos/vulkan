...
export class StdVideoH264SequenceParameterSet implements BaseStruct {
  ...
  get profile_idc(): StdVideoH264ProfileIdc {
  ...
  get level_idc(): StdVideoH264LevelIdc {
    return this.#view.getInt32(68, LE);
  }
  
  set level_idc(value: StdVideoH264LevelIdc) {
    this.#view.setInt32(68, Number(value), LE);
  }

  get chroma_format_idc(): StdVideoH264ChromaFormatIdc {
  ...
  get pic_order_cnt_type(): StdVideoH264PocType {
