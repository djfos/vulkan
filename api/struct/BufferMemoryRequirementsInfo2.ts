...
export class BufferMemoryRequirementsInfo2 implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitBufferMemoryRequirementsInfo2) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, BufferMemoryRequirementsInfo2.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
