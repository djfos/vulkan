...
export class FenceGetWin32HandleInfoKHR implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitFenceGetWin32HandleInfoKHR) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, FenceGetWin32HandleInfoKHR.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
