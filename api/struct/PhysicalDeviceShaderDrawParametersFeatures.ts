...
export class PhysicalDeviceShaderDrawParametersFeatures implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceShaderDrawParametersFeatures) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceShaderDrawParametersFeatures.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
