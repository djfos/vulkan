...
export class PhysicalDeviceImagelessFramebufferFeatures implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceImagelessFramebufferFeatures) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceImagelessFramebufferFeatures.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
