...
export class ImportSemaphoreFdInfoKHR implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitImportSemaphoreFdInfoKHR) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, ImportSemaphoreFdInfoKHR.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
