...
export class DedicatedAllocationImageCreateInfoNV implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitDedicatedAllocationImageCreateInfoNV) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, DedicatedAllocationImageCreateInfoNV.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
