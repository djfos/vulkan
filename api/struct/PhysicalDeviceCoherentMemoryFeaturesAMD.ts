...
export class PhysicalDeviceCoherentMemoryFeaturesAMD implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceCoherentMemoryFeaturesAMD) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceCoherentMemoryFeaturesAMD.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get deviceCoherentMemory(): Bool32 {
