...
export class PhysicalDeviceTilePropertiesFeaturesQCOM implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceTilePropertiesFeaturesQCOM) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceTilePropertiesFeaturesQCOM.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
