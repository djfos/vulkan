...
import { VideoDecodeCapabilityFlagsKHR } from "../def.ts";
...
export class VideoDecodeCapabilitiesKHR implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitVideoDecodeCapabilitiesKHR) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, VideoDecodeCapabilitiesKHR.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get flags(): VideoDecodeCapabilityFlagsKHR {
