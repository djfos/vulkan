...
export class PhysicalDeviceInlineUniformBlockFeatures implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceInlineUniformBlockFeatures) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceInlineUniformBlockFeatures.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
