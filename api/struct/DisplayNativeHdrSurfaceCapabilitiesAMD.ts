...
export class DisplayNativeHdrSurfaceCapabilitiesAMD implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitDisplayNativeHdrSurfaceCapabilitiesAMD) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, DisplayNativeHdrSurfaceCapabilitiesAMD.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get localDimmingSupport(): Bool32 {
