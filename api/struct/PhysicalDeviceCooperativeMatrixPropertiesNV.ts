...
export class PhysicalDeviceCooperativeMatrixPropertiesNV implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceCooperativeMatrixPropertiesNV) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceCooperativeMatrixPropertiesNV.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get cooperativeMatrixSupportedStages(): ShaderStageFlags {
