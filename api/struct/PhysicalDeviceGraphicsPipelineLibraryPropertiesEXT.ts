...
export class PhysicalDeviceGraphicsPipelineLibraryPropertiesEXT implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceGraphicsPipelineLibraryPropertiesEXT.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get graphicsPipelineLibraryFastLinking(): Bool32 {
  ...
  get graphicsPipelineLibraryIndependentInterpolationDecoration(): Bool32 {
