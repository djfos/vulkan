...
export class RenderPassInputAttachmentAspectCreateInfo implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitRenderPassInputAttachmentAspectCreateInfo) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, RenderPassInputAttachmentAspectCreateInfo.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get aspectReferenceCount(): number {
  ...
  get pAspectReferences(): Deno.PointerValue {
