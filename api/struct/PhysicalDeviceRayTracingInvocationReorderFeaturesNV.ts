...
export class PhysicalDeviceRayTracingInvocationReorderFeaturesNV implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceRayTracingInvocationReorderFeaturesNV) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceRayTracingInvocationReorderFeaturesNV.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get rayTracingInvocationReorder(): Bool32 {
