...
export class PhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get attachmentFeedbackLoopLayout(): Bool32 {
