...
export class SysmemColorSpaceFUCHSIA implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitSysmemColorSpaceFUCHSIA) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, SysmemColorSpaceFUCHSIA.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
