...
import { StructureType, ConservativeRasterizationModeEXT } from "../enum.ts";
import { PipelineRasterizationConservativeStateCreateFlagsEXT } from "../def.ts";
...
export class PipelineRasterizationConservativeStateCreateInfoEXT implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPipelineRasterizationConservativeStateCreateInfoEXT) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PipelineRasterizationConservativeStateCreateInfoEXT.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  /** Reserved */
  get flags(): PipelineRasterizationConservativeStateCreateFlagsEXT {
  ...
  get conservativeRasterizationMode(): ConservativeRasterizationModeEXT {
  ...
  get extraPrimitiveOverestimationSize(): number {
