...
export class PhysicalDeviceVulkan13Features implements BaseStruct {
  ...
  get descriptorBindingInlineUniformBlockUpdateAfterBind(): Bool32 {
  ...
  get pipelineCreationCacheControl(): Bool32 {
  ...
  get shaderDemoteToHelperInvocation(): Bool32 {
  ...
  get shaderTerminateInvocation(): Bool32 {
  ...
  get subgroupSizeControl(): Bool32 {
  ...
  get computeFullSubgroups(): Bool32 {
  ...
  get shaderZeroInitializeWorkgroupMemory(): Bool32 {
  ...
  get shaderIntegerDotProduct(): Bool32 {
