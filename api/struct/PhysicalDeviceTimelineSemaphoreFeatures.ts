...
export class PhysicalDeviceTimelineSemaphoreFeatures implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceTimelineSemaphoreFeatures) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceTimelineSemaphoreFeatures.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
