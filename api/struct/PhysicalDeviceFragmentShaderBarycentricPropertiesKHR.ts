...
export class PhysicalDeviceFragmentShaderBarycentricPropertiesKHR implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceFragmentShaderBarycentricPropertiesKHR) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceFragmentShaderBarycentricPropertiesKHR.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get triStripVertexOrderIndependentOfProvokingVertex(): Bool32 {
