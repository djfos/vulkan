...
export class MemoryZirconHandlePropertiesFUCHSIA implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitMemoryZirconHandlePropertiesFUCHSIA) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, MemoryZirconHandlePropertiesFUCHSIA.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
