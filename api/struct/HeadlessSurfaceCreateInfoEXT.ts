...
import { HeadlessSurfaceCreateFlagsEXT } from "../def.ts";
...
export class HeadlessSurfaceCreateInfoEXT implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitHeadlessSurfaceCreateInfoEXT) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, HeadlessSurfaceCreateInfoEXT.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get flags(): HeadlessSurfaceCreateFlagsEXT {
