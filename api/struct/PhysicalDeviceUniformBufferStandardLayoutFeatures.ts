...
export class PhysicalDeviceUniformBufferStandardLayoutFeatures implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceUniformBufferStandardLayoutFeatures) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceUniformBufferStandardLayoutFeatures.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
