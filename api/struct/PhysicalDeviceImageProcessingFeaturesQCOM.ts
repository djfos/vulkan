...
export class PhysicalDeviceImageProcessingFeaturesQCOM implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceImageProcessingFeaturesQCOM) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceImageProcessingFeaturesQCOM.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get textureSampleWeighted(): Bool32 {
