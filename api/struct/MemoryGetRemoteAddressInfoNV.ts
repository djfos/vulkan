...
export class MemoryGetRemoteAddressInfoNV implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitMemoryGetRemoteAddressInfoNV) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, MemoryGetRemoteAddressInfoNV.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
