...
import { ShaderStageFlags, Bool32, DeviceSize } from "../def.ts";
...
export class PhysicalDeviceVulkan13Properties implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceVulkan13Properties) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceVulkan13Properties.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
