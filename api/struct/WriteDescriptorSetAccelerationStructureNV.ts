...
export class WriteDescriptorSetAccelerationStructureNV implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitWriteDescriptorSetAccelerationStructureNV) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, WriteDescriptorSetAccelerationStructureNV.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
