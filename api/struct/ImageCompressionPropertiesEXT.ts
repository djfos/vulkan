...
export class ImageCompressionPropertiesEXT implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitImageCompressionPropertiesEXT) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, ImageCompressionPropertiesEXT.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get imageCompressionFlags(): ImageCompressionFlagsEXT {
  ...
  get imageCompressionFixedRateFlags(): ImageCompressionFixedRateFlagsEXT {
