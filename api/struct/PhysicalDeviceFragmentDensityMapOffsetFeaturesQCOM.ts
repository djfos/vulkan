...
export class PhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get fragmentDensityMapOffset(): Bool32 {
