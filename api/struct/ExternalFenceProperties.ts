...
export class ExternalFenceProperties implements BaseStruct {
  ...
  get exportFromImportedHandleTypes(): ExternalFenceHandleTypeFlags {
  ...
  get compatibleHandleTypes(): ExternalFenceHandleTypeFlags {
  ...
  get externalFenceFeatures(): ExternalFenceFeatureFlags {
