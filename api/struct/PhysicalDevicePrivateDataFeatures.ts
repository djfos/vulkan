...
export class PhysicalDevicePrivateDataFeatures implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDevicePrivateDataFeatures) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDevicePrivateDataFeatures.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
