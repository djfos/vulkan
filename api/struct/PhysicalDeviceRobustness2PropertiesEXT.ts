...
export class PhysicalDeviceRobustness2PropertiesEXT implements BaseStruct {
  ...
  get robustStorageBufferAccessSizeAlignment(): bigint {
    return this.#view.getBigUint64(16, LE);
  }
  
  set robustStorageBufferAccessSizeAlignment(value: number | bigint) {
    this.#view.setBigUint64(16, BigInt(value), LE);
  }

  get robustUniformBufferAccessSizeAlignment(): bigint {
    return this.#view.getBigUint64(24, LE);
  }
  
  set robustUniformBufferAccessSizeAlignment(value: number | bigint) {
