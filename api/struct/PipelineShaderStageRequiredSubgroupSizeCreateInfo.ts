...
export class PipelineShaderStageRequiredSubgroupSizeCreateInfo implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPipelineShaderStageRequiredSubgroupSizeCreateInfo) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PipelineShaderStageRequiredSubgroupSizeCreateInfo.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get requiredSubgroupSize(): number {
