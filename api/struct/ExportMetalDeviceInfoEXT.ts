...
import { MTLDevice_id } from "../def.ts";
...
export class ExportMetalDeviceInfoEXT implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitExportMetalDeviceInfoEXT) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, ExportMetalDeviceInfoEXT.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
