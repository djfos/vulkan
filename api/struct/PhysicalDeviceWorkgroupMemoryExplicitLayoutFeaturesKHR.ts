...
export class PhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR implements BaseStruct {
  ...
  get workgroupMemoryExplicitLayout(): Bool32 {
  ...
  get workgroupMemoryExplicitLayoutScalarBlockLayout(): Bool32 {
  ...
  get workgroupMemoryExplicitLayout8BitAccess(): Bool32 {
  ...
  get workgroupMemoryExplicitLayout16BitAccess(): Bool32 {
