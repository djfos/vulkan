...
export class PhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get rasterizationOrderColorAttachmentAccess(): Bool32 {
  ...
  get rasterizationOrderDepthAttachmentAccess(): Bool32 {
  ...
  get rasterizationOrderStencilAttachmentAccess(): Bool32 {
