...
import {PhysicalDeviceProperties} from "./PhysicalDeviceProperties.ts";
...
export class PhysicalDeviceProperties2 implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceProperties2) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceProperties2.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
