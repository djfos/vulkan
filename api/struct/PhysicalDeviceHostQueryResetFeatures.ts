...
export class PhysicalDeviceHostQueryResetFeatures implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceHostQueryResetFeatures) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceHostQueryResetFeatures.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
