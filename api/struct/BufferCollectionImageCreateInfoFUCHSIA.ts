...
export class BufferCollectionImageCreateInfoFUCHSIA implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitBufferCollectionImageCreateInfoFUCHSIA) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, BufferCollectionImageCreateInfoFUCHSIA.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  set collection(value: AnyPointer) {
