...
export class MemoryGetZirconHandleInfoFUCHSIA implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitMemoryGetZirconHandleInfoFUCHSIA) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, MemoryGetZirconHandleInfoFUCHSIA.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
