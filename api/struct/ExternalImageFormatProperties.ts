...
export class ExternalImageFormatProperties implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitExternalImageFormatProperties) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, ExternalImageFormatProperties.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
