...
export class PhysicalDevicePipelinePropertiesFeaturesEXT implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDevicePipelinePropertiesFeaturesEXT) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDevicePipelinePropertiesFeaturesEXT.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get pipelinePropertiesIdentifier(): Bool32 {
