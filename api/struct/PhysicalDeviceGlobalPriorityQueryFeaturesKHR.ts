...
export class PhysicalDeviceGlobalPriorityQueryFeaturesKHR implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceGlobalPriorityQueryFeaturesKHR) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceGlobalPriorityQueryFeaturesKHR.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get globalPriorityQuery(): Bool32 {
