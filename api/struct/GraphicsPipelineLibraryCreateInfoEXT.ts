...
import { GraphicsPipelineLibraryFlagsEXT } from "../def.ts";
...
export class GraphicsPipelineLibraryCreateInfoEXT implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitGraphicsPipelineLibraryCreateInfoEXT) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, GraphicsPipelineLibraryCreateInfoEXT.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get flags(): GraphicsPipelineLibraryFlagsEXT {
