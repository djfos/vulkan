...
import { EventCreateFlags } from "../def.ts";
...
export class EventCreateInfo implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitEventCreateInfo) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, EventCreateInfo.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
