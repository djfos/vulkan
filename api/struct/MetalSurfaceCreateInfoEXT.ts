...
import { MetalSurfaceCreateFlagsEXT } from "../def.ts";
...
export class MetalSurfaceCreateInfoEXT implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitMetalSurfaceCreateInfoEXT) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, MetalSurfaceCreateInfoEXT.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get flags(): MetalSurfaceCreateFlagsEXT {
