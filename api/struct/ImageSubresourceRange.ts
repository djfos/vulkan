...
export class ImageSubresourceRange implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitImageSubresourceRange) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, ImageSubresourceRange.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  }
