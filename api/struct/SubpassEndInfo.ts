...
export class SubpassEndInfo implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitSubpassEndInfo) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, SubpassEndInfo.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
