...
export class PhysicalDeviceShaderSubgroupExtendedTypesFeatures implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceShaderSubgroupExtendedTypesFeatures) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceShaderSubgroupExtendedTypesFeatures.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
