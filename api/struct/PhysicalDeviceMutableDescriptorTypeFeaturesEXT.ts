...
export class PhysicalDeviceMutableDescriptorTypeFeaturesEXT implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceMutableDescriptorTypeFeaturesEXT) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceMutableDescriptorTypeFeaturesEXT.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get mutableDescriptorType(): Bool32 {
