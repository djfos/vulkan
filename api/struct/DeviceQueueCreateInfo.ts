...
export class DeviceQueueCreateInfo implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitDeviceQueueCreateInfo) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, DeviceQueueCreateInfo.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
