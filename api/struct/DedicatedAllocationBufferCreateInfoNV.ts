...
export class DedicatedAllocationBufferCreateInfoNV implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitDedicatedAllocationBufferCreateInfoNV) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, DedicatedAllocationBufferCreateInfoNV.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get dedicatedAllocation(): Bool32 {
