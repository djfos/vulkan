...
export class OpticalFlowImageFormatPropertiesNV implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitOpticalFlowImageFormatPropertiesNV) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, OpticalFlowImageFormatPropertiesNV.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
