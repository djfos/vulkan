...
export class ImageViewUsageCreateInfo implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitImageViewUsageCreateInfo) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, ImageViewUsageCreateInfo.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
