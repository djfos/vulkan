...
export class ExternalMemoryImageCreateInfo implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitExternalMemoryImageCreateInfo) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, ExternalMemoryImageCreateInfo.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
