...
export class VideoSessionParametersUpdateInfoKHR implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitVideoSessionParametersUpdateInfoKHR) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, VideoSessionParametersUpdateInfoKHR.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get updateSequenceCount(): number {
