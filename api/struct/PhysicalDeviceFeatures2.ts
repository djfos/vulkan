...
export class PhysicalDeviceFeatures2 implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDeviceFeatures2) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDeviceFeatures2.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
