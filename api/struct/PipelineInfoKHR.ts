...
export class PipelineInfoKHR implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPipelineInfoKHR) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PipelineInfoKHR.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
