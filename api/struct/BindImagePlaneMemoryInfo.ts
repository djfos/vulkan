...
export class BindImagePlaneMemoryInfo implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitBindImagePlaneMemoryInfo) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, BindImagePlaneMemoryInfo.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get planeAspect(): ImageAspectFlagBits {
