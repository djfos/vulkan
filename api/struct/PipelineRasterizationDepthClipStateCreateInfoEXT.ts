...
import { PipelineRasterizationDepthClipStateCreateFlagsEXT, Bool32 } from "../def.ts";
...
export class PipelineRasterizationDepthClipStateCreateInfoEXT implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPipelineRasterizationDepthClipStateCreateInfoEXT) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PipelineRasterizationDepthClipStateCreateInfoEXT.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  /** Reserved */
  get flags(): PipelineRasterizationDepthClipStateCreateFlagsEXT {
