...
export class DescriptorSetLayoutSupport implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitDescriptorSetLayoutSupport) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, DescriptorSetLayoutSupport.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
