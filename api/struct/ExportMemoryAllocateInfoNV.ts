...
export class ExportMemoryAllocateInfoNV implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitExportMemoryAllocateInfoNV) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, ExportMemoryAllocateInfoNV.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  ...
  get handleTypes(): ExternalMemoryHandleTypeFlagsNV {
