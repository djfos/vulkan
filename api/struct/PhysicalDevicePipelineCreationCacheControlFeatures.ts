...
export class PhysicalDevicePipelineCreationCacheControlFeatures implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitPhysicalDevicePipelineCreationCacheControlFeatures) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, PhysicalDevicePipelineCreationCacheControlFeatures.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
