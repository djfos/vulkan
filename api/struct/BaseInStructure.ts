...
export class BaseInStructure implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitBaseInStructure) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, BaseInStructure.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
  }
