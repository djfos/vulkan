...
export class ImportMemoryBufferCollectionFUCHSIA implements BaseStruct {
  ...
  constructor(data?: Deno.PointerValue | Uint8Array | InitImportMemoryBufferCollectionFUCHSIA) {
    if (data === undefined || data === null) {
      ...
      this.#data = new Uint8Array(Deno.UnsafePointerView.getArrayBuffer(data, ImportMemoryBufferCollectionFUCHSIA.size));
      this.#view = new DataView(this.#data.buffer, this.#data.byteOffset);
    }
